...
func Initialize(ctx context.Context, conf *config.Config) *Provider {
	...
	subscribeConsume := handle.NewSubscribeConsume(conf, wsClientSession, room, talkRecordsService, contactService, db, sensitiveMatchService)
